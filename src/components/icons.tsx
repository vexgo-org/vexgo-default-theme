...
/**
 * Lucide-style inline SVG icons. These are rendered into the static theme
 * HTML, so they must carry no runtime behavior — only the 24x24 stroke paths.
 * Icons inherit `currentColor` and pick up sizing/color via Tailwind classes
 * (e.g. `w-4 h-4 text-muted-foreground`).
 */
